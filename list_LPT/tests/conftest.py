...
def test_list_lpt(db, test_user_foreman):
    return ListLPT.objects.create(list_number="number_1", user=test_user_foreman, department="5000")


@pytest.fixture
def test_list_lpt_closed(db, test_user_foreman):
    return ListLPT.objects.create(list_number="number_2", user=test_user_foreman, department="5000", closed=True)
